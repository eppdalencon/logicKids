    ...
    var body: some View {
        GeometryReader { geometry in
            HStack(spacing:0){
                ...
                .frame(width:geometry.size.width * 0.09 ,height: geometry.size.height * 0.84)
                       ...
                       // Spacer()
                        ...
                        VStack(spacing:geometry.size.height * 0.05) {
                            HStack{
                                ...
                                HStack(spacing: 3){
                                    Button(action: {
                                       ...
                                       Text("True")
                                            .font(Font.titleNormalBold)
                                            .frame(width:geometry.size.width * 0.10, height: geometry.size.height * 0.08)
                            ...
                            Button(action: {
                               ...
                               Text("SendAnswer")
                                    .font(Font.titleNormalBold)
                                    .frame(width: geometry.size.width * 0.59, height: geometry.size.height * 0.08)
                                    .padding(10)
                                    .foregroundColor(Color.white)
